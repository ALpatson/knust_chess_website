...
const blogPosts = [
  ...
  },
  {
    ...
    author: "KNUST Chess Club",
    date: "May 2026",
    summary: "Like most people who are taught chess by family members, chess was only a means for Micheal Guiseppe Sarkodie to bond with his father until he met CM Cephas Clinton Formevor...",
    content: [
      "Like most people who are taught chess by family members, chess was only a means for Micheal Guiseppe Sarkodie to bond with his father until he met CM Cephas Clinton Formevor at St Peter’s Senior High School who coached him. As with many players, Micheal made it his mission to defeat his coach one day, something he proudly achieved. In his first classical chess tournament, the Kumasi chess classics, he made a resilient recovery after a demoralizing first three rounds which earned him the best student award at the tournament and that moment will forever remain etched in his memory.",
      "During his time at KNUST, he was successful in establishing the KNUST chess club as separate entity from the KNUST Chess & Scrabble club, a move that ensured chess was recognized by the sports’ directorate on campus and the Ghana Chess Association.",
      "Building on that success, Micheal now serves the chess community as the Ashanti Regional Chess Association’s president through initiatives such as the 'Chess in Schools' project, aimed at developing young talents in the Ashanti region. In addition, he also serves the Ghana Health Service as a medical doctor.",
      "Fun fact about him, he is one of the best speed chess players in Ghana."
    ],
